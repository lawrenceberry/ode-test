"""Packed-batch Rodas5 custom kernel using numba-cuda."""
...
def prepare_solve(
    ...
    *,
    ...
    blocks = (n + int(lu_solver.batches_per_block) - 1) // int(lu_solver.batches_per_block)
...
def run_prepared(prepared: PreparedSolve, *, return_stats=False, copy_solution=True):
    ...
    solution = workspace.hist_dev.copy_to_host() if copy_solution else workspace.hist_dev
    if not return_stats:
        return solution
